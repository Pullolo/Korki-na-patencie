          ...
          <div className="flex items-center gap-1.5">
            ...
            {showDashboardLink && (
              <Link
                ...
                className={cn(
                  btnSmall,
                  "bg-front-ground text-front-ink hover:bg-front-brand-soft hover:text-front-brand"
                )}
              >
                Panel
                <ArrowRight />
      ...
      <footer className="border-t border-front-line bg-front-surface">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-5 py-10 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <div className="flex items-center gap-2.5">
            <span className="flex size-9 items-center justify-center rounded-xl bg-front-brand text-white">
              <GraduationCap className="size-4.5" />
            </span>
            <span className="font-display font-semibold">Korki na patencie</span>
          </div>
